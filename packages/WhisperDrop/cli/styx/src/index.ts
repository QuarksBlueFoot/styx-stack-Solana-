...
import { registerWhisperDropCommands } from "./whisperdrop";
...
program.name("styx").description("Styx Stack CLI (tooling-only)").version("0.2.5");
...
registerWhisperDropCommands(program);
