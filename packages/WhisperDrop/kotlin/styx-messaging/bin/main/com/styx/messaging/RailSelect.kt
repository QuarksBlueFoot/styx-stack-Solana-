 ...
 * - callers can probe availability (e.g. by getAccountInfo on PMP program) and pass pmpAvailable.
 */
    ...
    fun selectRail(args: RailSelectArgs): OnchainRail {
        return when (args.prefer) {
            ...
            RailPreference.AUTO -> {
                ...
                if (memoChars <= args.memoMaxChars) OnchainRail.MEMO else if (args.pmpAvailable) OnchainRail.PMP else OnchainRail.MEMO
            }
        }
    }
}
