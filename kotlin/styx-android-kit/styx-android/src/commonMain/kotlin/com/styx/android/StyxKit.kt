...
import com.styx.messaging.MessagingConfig
...
class StyxKit private constructor(
    ...
    companion object {
        ...
        fun create(
            ...
            onMessage: ((com.styx.messaging.PrivateMessage) -> Unit)? = null
        ): StyxKit {
     ...
     */
    fun messageFlow(): SharedFlow<com.styx.messaging.PrivateMessage> =
